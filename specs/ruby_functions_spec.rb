...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    volume_result = volume_of_cube(5)
    assert_equal( 125, volume_result )
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_sphere_result = volume_of_sphere(2)
    assert_equal(33.51, volume_sphere_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    farenheit_to_celsius_result = farenheit_to_celsius(80)
    assert_equal(27, farenheit_to_celsius_result)
  end
